...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Profiles_company', (
        ...
        db.send_create_signal('Profiles', ['Company'])

        # Adding model 'Profile'
        db.create_table('Profiles_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Profiles.Company'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('Profiles_company')
