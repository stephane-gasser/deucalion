...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscussionDisclosure.contact_name'
        db.add_column('Messages_discussiondisclosure', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiscussionDisclosure.contact_name'
        db.delete_column('Messages_discussiondisclosure', 'contact_name')
    ...
    models = {
        'Messages.discussion': {
            ...
            'secret_hash': ('django.db.models.fields.CharField', [], {'default': "'f55dab20d28cce0cfc0519997bd39e58'", 'max_length': '64'}),
            'secret_hash_reply': ('django.db.models.fields.CharField', [], {'default': "'6a2fb2047569fd3497de1691706e9619'", 'max_length': '64'}),
