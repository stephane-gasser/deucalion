...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.secret_hash_reply'
        db.add_column('Messages_discussion', 'secret_hash_reply',
                      self.gf('django.db.models.fields.CharField')(default='c39ff8da340c48b25fd0f0898e51b256', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.secret_hash_reply'
        db.delete_column('Messages_discussion', 'secret_hash_reply')
    ...
    models = {
        'Messages.discussion': {
            ...
            'secret_hash': ('django.db.models.fields.CharField', [], {'default': "'6fef8d13e1a21444ef2b3ac76d8c0b52'", 'max_length': '64'}),
            'secret_hash_reply': ('django.db.models.fields.CharField', [], {'default': "'9bf6b40aeed7d2bde3892b6af5fdab7a'", 'max_length': '64'}),
