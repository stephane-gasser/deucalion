...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiscussionDisclosure'
        db.create_table('Messages_discussiondisclosure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('discussion', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['Messages.Discussion'], unique=True)),
        ...
        db.send_create_signal('Messages', ['DiscussionDisclosure'])


    def backwards(self, orm):
        # Deleting model 'DiscussionDisclosure'
        db.delete_table('Messages_discussiondisclosure')
    ...
    models = {
        'Messages.discussion': {
            ...
            'secret_hash': ('django.db.models.fields.CharField', [], {'default': "'c6e4062fccc6fc657484a8ddbfb0e885'", 'max_length': '64'}),
            'secret_hash_reply': ('django.db.models.fields.CharField', [], {'default': "'f57408b6cb1604f59aa52e43e1587229'", 'max_length': '64'}),
